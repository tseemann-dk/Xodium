...
Xodium can be used as a basic ingredient for many common application types across various platforms - just like sodium in table salt in your average household ...
